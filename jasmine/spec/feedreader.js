...
$(function() {
    ...
    */
    ...
    describe('The menu', () => {
        let bodyHasMenuHidden = $('body').hasClass('menu-hidden');
       ...
       it('is hidden by default', () => {
           expect(bodyHasMenuHidden).toEqual(true);
        });
    ...
    describe('Initial Entries', () => {
        ...
        it('loadFeed completes its work and has at least a single entry', () => {
    ...
    describe('New Feed Selection', () => {
        ...
        it('check if content actually change', () => {
